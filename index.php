...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <div class="row">
          <!--div with image slider starts here..Aligned to the left-->
          <div class="col-6 alert alert-secondary slider-column" >
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="../KOIMS/images/image_slider/image1.jpg" alt="First slide">
    ...
    <div class="carousel-item">
      <img class="d-block w-100" src="../KOIMS/images/image_slider/image3.jpg" alt="Third slide">
        <div class="carousel-caption d-none d-md-block">
    <h4>Donate Now</h4>
    <p>Let's help feed and house the needy</p>
      ...
      <div class="carousel-item">
      <img class="d-block w-100" src="../KOIMS/images/image_slider/image4.jpg" alt="Third slide">
          <div class="carousel-caption d-none d-md-block">
    ...
    <p>Help run an orphanage as a home for the needy</p>
      ...
      <div class="carousel-item">
      <img class="d-block w-100" src="../KOIMS/images/image_slider/image5.jpg" alt="Third slide">
          <div class="carousel-caption d-none d-md-block">
    ...
    <p>And be part of us</p>
      ...
      <img class="d-block w-100" src="../KOIMS/images/image_slider/image6.jpg" alt="Third slide">
          <div class="carousel-caption d-none d-md-block">
    <h4>Report any needy child to a nearby orphanage</h4>
    ...
    <p>Please let us know and put the baby into proper care</p>
      ...
      <div class="carousel-item">
      <img class="d-block w-100" src="../KOIMS/images/image_slider/image8.jpg" alt="Third slide">
          <div class="carousel-caption d-none d-md-block">
    ...
    <p>Feel most welcome to our orphan homesss..Be part of us too.</p>
      ...
      <div class="carousel-item">
      <img class="d-block w-100" src="../KOIMS/images/image_slider/image10.jpg" alt="Third slide">
          <div class="carousel-caption d-none d-md-block">
    <h4>&ldquo;Help us feel home and make a life too like you and your family&rdquo;-An Orphan</h4>
  </div>
    </div>
      <div class="carousel-item">
      <img class="d-block w-100" src="../KOIMS/images/image_slider/image11.jpg" alt="Third slide">
          <div class="carousel-caption d-none d-md-block">
    <h4>&ldquo;When you lose your parents as a child, yu are indoctrined into a club, you're retaken into life's severest confidence.You're undeceived &rdquo;-Hilary Thayer Hamann</h4>
      ...
      <div class="carousel-item">
      <img class="d-block w-100" src="../KOIMS/images/image_slider/image12.jpg" alt="Third slide">
          <div class="carousel-caption d-none d-md-block">
    <h4>&ldquo;Orphans are the only ones who get to choose their fathers, and they love them twice as much&rdquo;-Adam Johnson</h4>
      ...
      <div class="carousel-item">
      <img class="d-block w-100" src="../KOIMS/images/image_slider/image13.jpg" alt="Third slide">
          <div class="carousel-caption d-none d-md-block">
  ...
  <a class="carousel-control-next" href="#slideIndicators" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
          ...
          <!--div with "our mission" title starts here-->
    ...
    <h1>OUR MISSION:</h1>
        <p>In the heart of every child is a hunger for home. Not just for food and a place to sleep, but for safety and community. Most importantly for love.
                    <br>At the Kenyan Orphanages, found in most of Kenyan parts , there is much more than a home for many Kenyan
        ...
        We are a family, where God’s love guides us all as we grow and expand year after year.<br>
              ...
              <p>&ldquo;Perhaps there are those who are able to go about thier lives unfettered by such concerns.But for those like us, our fate is to face the world as orphans, chasing through long years the shadows of vanished parents.There is nothing for it but to try and see through our missions to the end, as best we can, for until we do so, we will be permitted no calm&rdquo;-by<div id="author"> Kazuo Ishiguro,When we were orphans</p></div>
      ...
      <!--section in the body starts here-->
      <div class="container">
      <div class="col-12">
          <section>
...
<li><a href="#">Orphan Population</a></li>
